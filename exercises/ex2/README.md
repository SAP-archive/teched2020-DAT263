...
5. Do an "automapping" and change the name and the data types at the target.
...
8. Open the "Projection" configuration and map the source columns "NOM_KEY1" and "NOM_KEY2" to the corresponding target columns. ![Connect new columns](./images/connectnewcolumns.png)
